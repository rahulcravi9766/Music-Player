...
import com.rahul_music_pod.tabbuttons.databinding.FragmentFavBinding
...
class FavFragment : Fragment(), ServiceConnection {
    private lateinit var adapterMusic: SongListAdapter
    private lateinit var favListBinding: FragmentFavBinding
